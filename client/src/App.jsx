...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#060b18] text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-300">
      
      <div className="flex flex-1 min-h-0">
        {/* 1. LEFT SIDEBAR NAVIGATION */}
        <aside 
          className={`sticky top-0 h-screen z-50 bg-white dark:bg-[#071A3D] border-r border-[#E5E7EB] dark:border-[#102856] transition-all duration-300 flex flex-col ${
    ...
    </div> {/* Close upper layout flex container */}

    {/* Footer */}
    <footer className="bg-[#0B1528] text-slate-350 border-t border-[#102856] py-12 px-6 lg:px-8 mt-auto text-left relative z-40 w-full">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        
        {/* Column 1: Brand Info */}
        <div className="space-y-4">
          <h3 className="text-base font-bold text-white font-heading m-0">Sri Gowthami Institutions</h3>
          <p className="text-xs text-slate-400 leading-relaxed m-0">
            Shaping tomorrow's leaders through excellence in education and holistic development since 2000.
          </p>
          <div>
            <h4 className="text-[10px] font-bold text-white uppercase tracking-widest mt-6 mb-3">Follow Us On Social Media</h4>
              ...
              {[
                ...
                return (
                  <a 
                    ...
                    className="w-8 h-8 rounded-full bg-white text-[#0B1528] flex items-center justify-center hover:bg-[#2563eb] hover:text-white transition-all duration-200 shadow-sm hover:-translate-y-0.5"
                  >
                    <Icon size={14} />
                  </a>
                );
        ...
        <div>
          <h3 className="text-sm font-bold text-white font-heading mb-4">Quick Links</h3>
          <ul className="space-y-2.5 p-0 list-none text-xs">
            {[
              "Scholarships and Fellowships",
              "Web portal for Fellowship/Scholarship Legacy Cases",
              "e-SARTS",
              "e-Schemes",
              "Syllabi for Choice Based Credit System (CBCS)",
              ...
              <li key={link} className="flex items-center gap-1.5">
                ...
                <a href="#" className="text-slate-400 hover:text-white hover:translate-x-1 transition-all duration-200 inline-block">{link}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          <h3 className="text-sm font-bold text-white font-heading mb-4">Other Links</h3>
          <ul className="space-y-2.5 p-0 list-none text-xs">
            {[
        ...
        <div className="space-y-4">
          ...
          <div className="text-[11px] text-slate-400 space-y-2 leading-relaxed">
            <p className="m-0"><strong className="text-slate-200">Society Name:</strong> Sri Gowthami Urban and Rural Integrated Development and Educational Society.</p>
            <p className="m-0"><strong className="text-slate-200">Address:</strong> Door No:4-1235/1,2, PODILI ROAD, DARSI, PRAKASAM DT, Andhra Pradesh, Indian Pin code: 523247</p>
          </div>
      ...
      {/* Copyright bar */}
      <div className="max-w-7xl mx-auto border-t border-slate-800/60 mt-8 pt-6 text-center text-xs text-slate-500">
        <p className="m-0">© 2025 Sri Gowthami Educational Institutions. All Rights Reserved.</p>
      </div>
    </footer>
      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className={`fixed bottom-6 z-50 p-3 bg-red-500 hover:bg-red-650 text-white rounded-xl shadow-lg transition-all duration-200 cursor-pointer active:scale-95 flex items-center justify-center border border-red-400/20 transition-all ${
              isSidebarOpen ? 'left-[284px]' : 'left-[104px]'
            }`}
            title="Scroll to Top"
          >
